...
import { Picker, Platform, StyleSheet, ScrollView, StatusBar, Text, TouchableNativeFeedback, TouchableHighlight, TextInput, View, Alert } from 'react-native';
      ...
      <View style={{ backgroundColor: "#FFF" }}>
        <StatusBar backgroundColor="#3c8dbc" barStyle="light-content" />
				...
				<View style={localStyles.Container}>
					...
					<TouchablePlatformSpecific onPress={() => this.forwardPacientData()}>

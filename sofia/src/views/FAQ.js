...
export default class FAQ extends Component {
  render() {
    const questions = [
      ...
      {
        key: "Por que minha teleconsultoria foi devolvida?",
        content:
      ...
      {
        key: "Por que minha teleconsultoria foi cancelada?",
        content:
      ...
      {
        key: "Por que minha teleconsultoria foi finalizada?",
        content:
      ...
      {
        key: "Como faço para ver minha resposta na SOFIA?",
        content:
      ...
      {
        key: "Como faço para avaliar a solicitação?",
        content:
      ...
      {
        key: "Quanto tempo tenho para ler a resposta?",
        content:
      ...
      {
        key: "O que ganho fazendo teleconsultorias?",
        content:

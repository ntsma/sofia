  ...
  render() {
    ...
    return (
      ...
      <Label>Grau de Atendimento</Label>
        ...
        <EvaluateButton navigation={this.props.navigation} data={this.props.data} sastifaction={this.state.sastifaction} attendance={this.state.attendance} buttonIsVisible={(this.props.data.status_id == 21) ? true : false} judgeType={this.props.judgeType} />
      </Card>
    );
  }
}

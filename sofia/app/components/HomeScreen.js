      ...
      <View>
        ...
        <View style={styles.Header}>
          <View style={styles.Container}>
            <Text style={[styles.TextLight, { fontSize: 20 }]}>Sofia</Text>
            <Text style={[styles.TextLight, { textAlign: "left" }]}>
              Bem vinda, Flávia!
            </Text>
          </View>
        </View>
        ...
        <View style={styles.Body}>
          ...
          >
            <TouchableNativeFeedback onPress={() => this.onNavigateNewIssue()}>
            ...
            >
              <View style={styles.Button}>
                <Icon style={styles.Icon} type="MaterialIcons" name="launch" />
            ...
            >
              <View style={styles.Button}>
                <Icon style={styles.Icon} type="MaterialIcons" name="cancel" />
            ...
            >
              <View style={styles.Button}>
                <Icon style={styles.Icon} type="MaterialIcons" name="create" />
            ...
            <TouchableNativeFeedback disabled={!this.state.isConnected}>
              <View style={styles.Button}>
                <Text
